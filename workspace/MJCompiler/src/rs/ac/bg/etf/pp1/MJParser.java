...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Jan 07 01:52:37 CET 2016
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$MJParser$act_num)
		...
		Obj func = (Obj)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-3)).value;
			   ...
			   if (func.getName().equals("chr") && !currentDesignator.getType().equals(Tab.intType))
				   parser.report_error("[Greska]Linija: " + funcleft + "\tParametri pri pozivu metode chr mora biti tipa int!", null);  
			   else if (func.getName().equals("ord") && !currentDesignator.getType().equals(Tab.charType))
				   parser.report_error("[Greska]Linija: " + funcleft + "\tParametri pri pozivu metode ord mora biti tipa int!", null);  
			   else if (func.getName().equals("len") && (currentDesignator.getType().getKind() != 6 || currentDesignator.getType().getKind() != Struct.Array))
